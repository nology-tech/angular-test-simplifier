...
Method searches the test component element and returns all debug elements matching the input css selector.
...
it("should render two elements with the .active class", () => {
    ...
    expect(testComp.queryAll(".active").length).toEqual(2);    
